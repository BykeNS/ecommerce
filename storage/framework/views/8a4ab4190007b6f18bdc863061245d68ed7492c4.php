                                      ...
                                      <table border='0' cellpadding='0' cellspacing='0' role='presentation' style='border-collapse:separate;line-height:100%;'>
                                        <tr>
                                          <td align='center' bgcolor='#ff6f6f' role='presentation' style='background-color:#ff6f6f;border:none;border-radius:5px;cursor:auto;padding:10px 25px;' valign='middle'>
                                            <a href='http://ecom.test' style='background:#ff6f6f;color:#ffffff;font-family:Oxygen, Helvetica neue, sans-serif;font-size:14px;font-weight:400;line-height:21px;margin:0;text-decoration:none;text-transform:none;' target='_blank'>
                                              Shop More
                                            </a>
                                          </td>
                                        </tr>
                                        ...
                                        <tr>
                                          <td >
                                            <a href='#' target='_blank'>
                                              <img alt='item1' height='auto' src='<?php echo e($message->embed($item->options->image)); ?>' width='110' />
                                            </a>
                                          </td>
                                        </tr>
                                      </tbody>
...
<?php /**PATH C:\laragon\www\ecom\resources\views/email/customer.blade.php ENDPATH**/ ?>