    ...
    <div class="services-breadcrumb">
        <div class="inner_breadcrumb">
            ...
            <ul class="short">
                ...
                <li class="text-center">Search Page</li>

            </ul>
        </div>
    </div>
</div>
<?php if(!empty($query) &&  count($products) > 0): ?>

  <div class="text-center" style="margin: 31px;">
	<h3>Search results for "<?php echo e(request()->input('q')); ?>"</h3>
     <h4 >Total <span class="badge badge-primary"><?php echo e(count($products)); ?></span></h4>
  </div>
                                ...
                                <div class="gd-box-info text-center">
                                    <div class="product-men women_two bot-gd">
                                        <div class="product-googles-info slide-img googles">
                                            <div class="men-pro-item">
                                                <div class="men-thumb-item">
                                                    <img src="<?php echo e(asset('frontend/images/s5.jpg')); ?>" class="img-fluid" alt=""  lazy="loading">
                                                    <div class="men-cart-pro">
                                                        <div class="inner-men-cart-pro">
                                ...
                                <div class="gd-box-info text-center">
                                    <div class="product-men women_two bot-gd">
                                        <div class="product-googles-info slide-img googles">
                                            <div class="men-pro-item">
                                                <div class="men-thumb-item">
                                                    <img src="<?php echo e(asset('frontend/images/s6.jpg')); ?>" class="img-fluid" alt="" lazy="loading">
                                                    <div class="men-cart-pro">
                                                        <div class="inner-men-cart-pro">
                                                            <a href="single.html" class="link-product-add-cart">Quick View</a>
                                                        </div>
                                ...
                                <div class="gd-box-info text-center">
                                    <div class="product-men women_two bot-gd">
                                        <div class="product-googles-info slide-img googles">
                                            <div class="men-pro-item">
                                                <div class="men-thumb-item">
                                                    <img src="<?php echo e(asset('frontend/images/s7.jpg')); ?>" class="img-fluid" alt=""  lazy="loading">
                                                    <div class="men-cart-pro">
                                                        <div class="inner-men-cart-pro">
                                                            <a href="single.html" class="link-product-add-cart">Quick View</a>
                                                        </div>
                                ...
                                <div class="gd-box-info text-center">
                                    <div class="product-men women_two bot-gd">
                                        <div class="product-googles-info slide-img googles">
                                            <div class="men-pro-item">
                                                <div class="men-thumb-item">
                                                    <img src="<?php echo e(asset('frontend/images/s8.jpg')); ?>" class="img-fluid" alt=""  lazy="loading">
                                                    <div class="men-cart-pro">
                                                        <div class="inner-men-cart-pro">
                                                            <a href="single.html" class="link-product-add-cart">Quick View</a>
                                                        </div>
                                ...
                                <div class="gd-box-info text-center">
                                    <div class="product-men women_two bot-gd">
                                        <div class="product-googles-info slide-img googles">
                                            <div class="men-pro-item">
                                                <div class="men-thumb-item">
                                                    <img src="<?php echo e(asset('frontend/images/s9.jpg')); ?>" class="img-fluid" alt="" lazy="loading">
                                                    <div class="men-cart-pro">
                                                        <div class="inner-men-cart-pro">
                                                            <a href="single.html" class="link-product-add-cart">Quick View</a>
                                                        </div>
                                ...
                                <div class="gd-box-info text-center">
                                    <div class="product-men women_two bot-gd">
                                        <div class="product-googles-info slide-img googles">
                                            <div class="men-pro-item">
                                                <div class="men-thumb-item">
                                                    <img src="<?php echo e(asset('frontend/images/s10.jpg')); ?>" class="img-fluid" alt="" lazy="loading">
                                                    <div class="men-cart-pro">
                                                        <div class="inner-men-cart-pro">
                                                            <a href="single.html" class="link-product-add-cart">Quick View</a>
                                                        </div>
                ...
                <div class="row galsses-grids pt-lg-5 pt-3">
                    <div class="col-lg-6 galsses-grid-left">
                        <figure class="effect-lexi">
                            <img src="<?php echo e(asset('frontend/images/banner4.jpg')); ?>" alt="" class="img-fluid" lazy="loading">
                            <figcaption>
                                <h3>Editor's
                                    <span>Pick</span>
                                </h3>
                    ...
                    <div class="col-lg-6 galsses-grid-left">
                        <figure class="effect-lexi">
                            <img src="<?php echo e(asset('frontend/images/banner1.jpg')); ?>" alt="" class="img-fluid" lazy="loading">
                            <figcaption>
                                <h3>Editor's
                                    <span>Pick</span>
                                </h3>
...
<div class="text-center">
 <h2 style="margin: 31px;">No results for "<?php echo e(request()->input('q')); ?>" </h2>
</div>
...
<?php echo $__env->make('frontend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\ecom\resources\views/frontend/pages/search.blade.php ENDPATH**/ ?>