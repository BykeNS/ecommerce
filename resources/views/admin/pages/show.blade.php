          ...
          @endforeach
              <div class="mt-4">
                ...
                @foreach ($product->category as $category)
                    <div class="btn btn-secondary ml-1">{{ $category->name }}</div>
                @endforeach
            ...
            @endforeach
            <div class=" col-sm-6">
              <h3 class="mb-0 mt-3">{{ $product->name }}</h3>
              <div class="col-sm-4 offset-sm-8 mb-3 ">
                <a href="{{ url('admin/product/edit',$product->slug) }}" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Edit Product</a>
              </div>
