                ...
                <ul class="cart-inner-info">
                    ...
                    @auth
                        {{ ucfirst(Auth::user()->name )}}
                            ...
                            <a class="btn btn-default" style="margin-bottom: 10px;" href="{{ route('logout') }}"
                    ...
                    @endauth
                     @guest
                     <a   class="btn btn-default m-2 "  href="{{ route('login') }}">
                    ...
                    <li class="galssescart galssescart2 cart cart box_1">
                            ...
                            <a href="{{ route('cart') }}"><button class="top_googles_cart" >
                                My Cart
                                <i class="fas fa-shopping-cart"></i>
                                <span class="badge badge-primary" id='lblCartCount'>{{ Cart::count() === 0 ? '' : Cart::count()}}</span>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 media-list span4 text-left">
                                        ...
                                        <div class="media-mini mt-3">
                                            <a href="shop.html">
                                                <img src="{{ asset('frontend/images/g2.jpg') }}" class="img-fluid" alt=""  lazy="loading">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-md-4 media-list span4 text-left">
                                        ...
                                        <div class="media-mini mt-3">
                                            <a href="shop.html">
                                                <img src="{{ asset('frontend/images/g3.jpg') }}" class="img-fluid" alt=""  lazy="loading">
                                            </a>
                                        </div>
                            ...
                            <li>
                                <div class="row">
                                    ...
                                    <div class="col-md-4 media-list span4 text-left">
                                        ...
                                        <div class="media-mini mt-3">
                                            <a href="shop.html">
                                                <img src="{{ asset('frontend/images/g1.jpg') }}" class="img-fluid" alt=""  lazy="loading">
                                            </a>
                                        </div>
